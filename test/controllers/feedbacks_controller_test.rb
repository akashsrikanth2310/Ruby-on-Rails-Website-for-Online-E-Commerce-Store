...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { comments: @feedback.comments, email: @feedback.email, name: @feedback.name } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { comments: @feedback.comments, email: @feedback.email, name: @feedback.name } }
