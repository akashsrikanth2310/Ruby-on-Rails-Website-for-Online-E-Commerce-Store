...
class PaymentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_detail" do
    assert_difference('PaymentDetail.count') do
      post payment_details_url, params: { payment_detail: { card_number: @payment_detail.card_number, cvv: @payment_detail.cvv, expiry: @payment_detail.expiry, name: @payment_detail.name } }
    end
  ...
  test "should update payment_detail" do
    patch payment_detail_url(@payment_detail), params: { payment_detail: { card_number: @payment_detail.card_number, cvv: @payment_detail.cvv, expiry: @payment_detail.expiry, name: @payment_detail.name } }
